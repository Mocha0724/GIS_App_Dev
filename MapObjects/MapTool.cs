...
namespace MapObjects
{
    public class MapTool
    {
        ...
        /// <returns></returns>
        public static double GetDistanceFromPointToSegment(double x0, double y0, double x1, double y1, double x2, double y2)
        {
            //思路：采用向量內积法
        ...
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static bool IsPointOnMultiPolyline(GeoPoint point, GeoPolyline multiPolyline, double tolerance)
        {
        ...
        /// <returns></returns>
        public static bool IsPointWithinMultiPolygon(GeoPoint point, GeoPolygon multiPolygon)
        {
        ...
        /// <param name="box"></param>
        /// <returns></returns>
        public static bool IsMultiPolylinePartiallyWithinBox(GeoPolyline multipolyline, GeoRectangle box)
        {
        ...
        /// <param name="box"></param>
        /// <returns></returns>
        public static bool IsMultiPolygonPartiallyWithinBox(GeoPolygon multipolygon, GeoRectangle box)
        {
            //思路：先判断矩形盒是否相交，如是，按如下顺序，满足任何一个条件，则返回True
            //（1）复合多边形任何一个点位于矩形盒内;
            //（2）矩形盒任何一个顶点位于复合多边形内
        ...
        /// <param name="multiPolygon"></param>
        /// <returns></returns>
        public static GeoPoint GetLabelPointOfMultiPolygon(GeoPolygon multiPolygon)
        {
