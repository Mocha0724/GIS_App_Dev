...
namespace MapObjects
{
    public class ClassBreakRenderer:Renderer
    {
        ...
        private List<Symbol> _Symbols = new List<Symbol>();//符号集合，小于第一个分割值对应第一个符号，依此类推
        ...
        public override Type RendererType
        {
            get
            {
                return typeof(ClassBreakRenderer);
            }
        }
        ...
        public void AddBreakValues(double[] values, Symbol[] symbols)
        {
        ...
        {
            ClassBreakRenderer sRenderer = new ClassBreakRenderer();
