...
namespace MapObjects
{
    public class SimpleMarkerSymbol:Symbol
    {
        ...
        private SimpleMarkerSymbolStyleConstant _Style = SimpleMarkerSymbolStyleConstant.SolidCircle;    //形状
        private Color _Color = Color.LightPink; //颜色
        private double _Size = 3;   //尺寸(mm)
        ...
        public override SymbolTypeConstant SymbolType
        {
            get
            {
                return SymbolTypeConstant.SimpleMarkerSymbol;
            }
        }
