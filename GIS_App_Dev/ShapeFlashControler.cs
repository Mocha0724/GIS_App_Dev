...
{
    internal class ShapeFlashControler
    {

        #region 字段

        private Shape[] mShapes;      //图形集合
        ...
        private System.Windows.Forms.Timer mTimer = new System.Windows.Forms.Timer();     //时钟，用于时间控制
        ...
        internal void StartFlash(Shape[] shapes, Int32 times, Int32 interval)
        {
            if (shapes.Length == 0)
                return;
            if (times <= 0)
        ...
        //需要绘制正在闪烁的图形
        internal delegate void NeedDrawFlashShapesHandle(object sender, Shape[] shapes);
